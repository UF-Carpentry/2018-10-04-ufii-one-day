...
humandate: "October 4, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Joseph Andreoli", "Matthew Collins"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Joshua Der", "Miao Sun", "Nitya Singh", "Deb Paul"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2018-10-04-ufii-one-day"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p>
  ...
  and registration is required. A fee of $23.00 will 
  be charged and lunch will be provided. 
